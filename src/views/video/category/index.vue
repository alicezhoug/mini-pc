  ...
  <div class="container">
    <div class="panel">
      <div style="position: relative; height: 100%">
        ...
        <CrudOperation
          :add-permission="['video:category:add']"
          :edit-permission="['video:category:edit']"
          :del-permission="['video:category:del']"
          :download-permission="['video:category:list']"

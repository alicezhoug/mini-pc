  ...
  <div class="container">
    <div class="panel">
      <div style="position: relative; height: 100%">
        ...
        <CrudOperation
          :add-permission="['bobosns:collect:add']"
          :edit-permission="['bobosns:collect:edit']"
          :del-permission="['bobosns:collect:del']"
          :download-permission="['bobosns:collect:list']"
...
<script lang="ts" setup>
  ...
  import { Collect } from '@/api/bobosns/collect';
  ...
  const { t } = useI18n();
  const crud = useCrud<Collect>({
    tag: '帖子收藏明细',
    url: '/bobosns/collect',
    title: 'menu.bobosns.collect',
    tableInfo: {
      componentConfig: {
        stripe: false,
      },

          ...
          <template #addForm>
            ...
            <a-row>
				...
				<a-col :span="12">
					<a-form-item
					  field="code"
					  :label="$t('system.dept.table.code')">
					  <a-input v-model="crud.options.form.code"  />	
					</a-form-item>	
				</a-col>
            </a-row>
            <!--顶级部门/状态-->
        ...
        >
          ...
          <template #code="{ record }">
            ...
            <div v-if="!record.editable && crud.options.tableInfo.isEdit">
              ...
              <div v-if="crud.options.form[record.id]">
                {{
                  crud.options.form[record.id].code
                    ? crud.options.form[record.id].code
                    : record.code
                }}
              </div>
            ...
            <div v-if="record.editable">
              <a-input
                v-model="crud.options.form[record.id].code"
...
<script lang="ts" setup>
  ...
  crud.update.setTableColumns([
	...
	{
	  title: t('system.dept.table.code'),
	  dataIndex: 'code',
	  width: 150,
	  display: true,
	  slotName: 'code',

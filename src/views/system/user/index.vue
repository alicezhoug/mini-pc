              ...
              <a-row>
                <a-col :span="12">
                  <a-form-item
                    ...
                    :rules="[{ required: false, message: '性别不能为空' }]"
                  >
...
<script lang="ts" setup>
  ...
  crud.hook.beforeOpenAdd = () => {
	...
	crud.options.form.username="";
	crud.options.form.phone="";
	crud.options.form.nickName="";
	crud.options.form.email="";
	crud.options.form.deptId="";
	crud.options.form.gender="";
	crud.options.form.enabled="";
	crud.options.form.roleIds="";
  ...
  crud.update.setTableColumns([
	...
	{
	  title: t('system.user.table.deviceId'),
	  dataIndex: 'deviceId',
	  width: 150,
	  display: true,
	  slotName: 'deviceId',
	...
	{
	  title: t('system.user.table.deviceUuid'),
